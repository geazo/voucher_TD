            ...
            <div class="col-md-8">
                <div class="card shadow-sm border-0 border-top border-primary border-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="alert alert-info border-0 mb-4 shadow-sm" style="background-color: #f8fbff;">
                            <div class="row">
                                ...
                                <div class="col-12 mb-3 pb-3 border-bottom" style="border-color: #cce3f6 !important;">
                                    <span class="text-muted small"><i class="bi bi-clock-history me-1"></i>Waktu Topup
                                        Awal:</span><br>
                                    <strong
                                        class="text-dark">{{ \Carbon\Carbon::parse($transaction->created_at)->format('d M Y, H:i') }}
                                        WIB</strong>
                                </div>

                                <div class="col-sm-6 mb-2">
                                    <span class="text-muted small"><i class="bi bi-wallet2 me-1"></i>Sisa Saldo
                                        Uang:</span><br>
                                    <strong class="text-success fs-5">Rp
                                        {{ number_format($saldoUang, 0, ',', '.') }}</strong>
                                </div>

                                <div class="col-sm-6 mb-2">
                                    <span class="text-muted small"><i class="bi bi-star-fill text-warning me-1"></i>Sisa
                                        Saldo Poin:</span><br>
                                    <strong class="text-primary fs-5">{{ number_format($saldoPoin, 0, ',', '.') }}
                                        Pts</strong>
                                </div>

                                <div class="col-12 mt-2 pt-3 border-top" style="border-color: #cce3f6 !important;">
                                    <span class="text-muted small"><i class="bi bi-calendar-x me-1"></i>Tanggal Kedaluwarsa
                                        Saat Ini:</span><br>
                                    <strong
                        ...
                        <form action="{{ route('admin.extensions.store') }}" method="POST">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('customers.show', $transaction->wallet->customer_id) }}"
