            ...
            @auth
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    @if (Auth::user()->role === 'superadmin')
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu shadow-sm border-0 mt-2" aria-labelledby="adminDropdown">
                                <li>
                                    <a class="dropdown-item {{ request()->routeIs('admin.transactions') ? 'active bg-success text-white' : '' }}"
                                        href="{{ route('admin.transactions') }}">Riwayat Transaksi
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item {{ request()->routeIs('admin.items.index') ? 'active bg-success text-white' : '' }}"
                                        href="{{ route('admin.items.index') }}">Master Item
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item {{ request()->routeIs('customers.index') ? 'active bg-success text-white' : '' }}"
                                        href="{{ route('customers.index') }}">Master Customer
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item {{ request()->routeIs('memberships.*') ? 'active bg-success text-white' : '' }}"
                                        href="{{ route('memberships.index') }}">
                                        Master Membership
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item {{ request()->routeIs('superadmin.extensions.index') ? 'active bg-success text-white' : '' }}"
                                        href="{{ route('superadmin.extensions.index') }}">Approval Extensi Saldo
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a class="dropdown-item {{ request()->routeIs('operators.*') ? 'active bg-success text-white' : '' }}"
                                        href="{{ route('operators.index') }}"><i class="bi bi-shield-lock me-1"></i> Master
                                        Operator
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu shadow-sm border-0 mt-2" aria-labelledby="kasirDropdown">
                                <li><a class="dropdown-item {{ request()->routeIs('topup.index') ? 'active bg-success text-white' : '' }}"
                                        href="{{ route('topup.index') }}">Topup Customer</a></li>
                                <li><a class="dropdown-item {{ request()->routeIs('customers.create') ? 'active bg-success text-white' : '' }}"
                                        href="{{ route('customers.create') }}">Registrasi Customer</a></li>
                                <li><a class="dropdown-item {{ request()->routeIs('scan.index') ? 'active bg-success text-white' : '' }}"
                                        href="{{ route('scan.index') }}">Payment</a></li>
                            </ul>
                        </li>
                    @endif
                    ...
                    @if (Auth::user()->role === 'admin')
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('admin.transactions') ? 'active fw-bold text-success' : '' }}"
                                href="{{ route('admin.transactions') }}">
                                Riwayat Transaksi
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('admin.items.index') ? 'active fw-bold text-success' : '' }}"
                                href="{{ route('admin.items.index') }}">
                                Master Item
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('memberships.*') ? 'active fw-bold text-success' : '' }}"
                                href="{{ route('memberships.index') }}">
                                Master Membership
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('customers.index') ? 'active fw-bold text-success' : '' }}"
                ...
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle fw-semibold" href="#" id="navbarDropdown" role="button"
                            ...
                            <span
                                class="badge {{ Auth::user()->role === 'superadmin' ? 'bg-danger' : (Auth::user()->role === 'admin' ? 'bg-primary' : 'bg-secondary') }} ms-1">
